...
// 처음에는 floor가 세워져 있음. 90도 돌리기 위해 x를 -pi/2로 세팅
...
door.position.y = 1;
door.position.z = 2 + 0.01; // solve z-fighting problem
house.add(door);
 ...
 */
// Ambient light
const ambientLight = new THREE.AmbientLight("#86cdff", 0.275); // moonlight color
...
// group.children으로 그룹 하위의 mesh들 모두 접근 가능!
